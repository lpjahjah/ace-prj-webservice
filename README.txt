...
a persistence unit "webservicePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "webservice/pom.xml":
...
artifact ("webservice.war") is already built. You can build
